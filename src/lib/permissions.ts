...
const PERMISSION_COPY = [
  ...
  ['ADJUST_721_TIERS', 'Adjust NFT tiers', 'Add, remove, or change the project’s NFT shop tiers.'],
  ['SET_721_METADATA', 'Set NFT metadata', 'Update the NFT collection’s metadata.'],
  ['MINT_721', 'Mint NFTs', 'Mint project NFTs without a payment.'],
  ['SET_721_DISCOUNT_PERCENT', 'Set NFT discount', 'Set the discount applied to NFT prices.'],
