    ...
    blocks: [
      {
        type: 'links',
        items: [
          { href: '/build/first-payment#read', label: 'Run the complete wallet-free read tutorial' },
      ...
      {
        type: 'text',
        text: 'The tutorial starts with Base Sepolia project 1, so you do not need to launch or find a project first. It pins SDK and viem versions, resolves the current controller from JBDirectory, reports the block hash, and explains expected output and recovery. The displayed source and downloadable example are the same file.',
      },
      {
        type: 'table',
