...
/**
 * Reconstruct the `Qm…` CIDv0 from a stored bytes32 digest (the reverse of
 * `cidV0ToBytes32`): multihash 0x12 0x20 + digest, base58-encoded. Null for
 * malformed or all-zero digests.
 */
export function bytes32ToCidV0(hex: `0x${string}`): string | null {
